#!/system/bin/sh
ui_print "- VirtualCam Manager v2.0.2-dev (pure Magisk + Zygisk, NO LSPosed)"
...
echo -n "2.0.2-dev" > /data/adb/virtualcam/module_version
echo -n "2.0.2-dev" > /data/adb/virtualcam/version
